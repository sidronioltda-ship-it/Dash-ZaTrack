          ...
          <div className="glass-panel relative overflow-hidden rounded-[2.25rem] p-6 sm:p-8">
            ...
            <div className="relative">
              <Badge className="gap-2">
                ...
                ZaTrack — Escale no X1 com Precisao
              </Badge>
              <div className="mt-8 max-w-3xl">
                ...
                <p className="mt-5 max-w-2xl text-base leading-8 text-muted-foreground">
                  Sistema avancado de tracking deterministico para campanhas de
                  WhatsApp + Meta Ads + Checkout. Tudo em tempo real.
                </p>
              </div>
